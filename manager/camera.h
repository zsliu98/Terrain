...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, GLfloat deltaTime) {
        ...
        if (direction == RIGHT)
            this->Position += this->Right * velocity;
        if (abs(this->Position.x) > distance_max) {
            this->Position.x = this->Position.x / abs(this->Position.x) * distance_max;
        }
        if (abs(this->Position.z) > distance_max) {
            this->Position.z = this->Position.z / abs(this->Position.z) * distance_max;
        }
        if (this->Position.y < height_min) {
            this->Position.y = height_min;
        }
        if (this->Position.y > height_max) {
            this->Position.y = height_max;
        }
    }
